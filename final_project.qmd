...
As a result, `r num_dropped` countries were dropped from the dataset due to having more than 20% missing values. This includes countries such as `r example_countries[1]`, `r example_countries[2]`, `r example_countries[3]`. The excessive amount of missing data for these countries is probably due to political, economic, or historical factors.
...
$$
where $\hat{y}_i$ represents the predicted values of average life expectancy.
