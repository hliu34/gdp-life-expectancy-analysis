...
animate(animated_over_time, renderer = gifski_renderer(), nframes = 150, duration = 25)
```
...
# variance in the reponse values <- actual life expectancy
# variance in the fitted value <- predicted life expectancy
# variance in the residual <-  amount of variability in the responses that was not accounted for
